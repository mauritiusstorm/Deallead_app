...
export function PlayerBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-14 z-40 border-t border-white/10 bg-noir/95 backdrop-blur sm:bottom-0">
      ...
      <Link to="/player" className="flex items-center gap-3 px-4 py-2.5">
        ...
        <div className="min-w-0 flex-1">
          <p className="truncate text-sm font-medium text-blanc">{track.title}</p>
      ...
      <div className="absolute right-3 top-1/2 flex -translate-y-1/2 items-center gap-1">
        <button
          ...
          className="rounded-full p-2 text-blanc hover:bg-white/10"
        >
          <SkipBack />
        </button>
        <button
